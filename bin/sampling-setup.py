...
parser.add_option("--mpiexecutable",dest="mpi_executable_location",default="mpiexec",help="Use this option to specify a path to mpiexec if it is not in your PATH by defualt.")
parser.add_option("--hosts",dest="hosts",help="Comma separated list of ssh host names to use for MPI functionality of Bertini.")
parser.add_option("--bertini",dest="bertini_executable_location",default="bertini",help="Use this option to specify a path to bertini if it is not in your PATH by defualt.")
...
# /cise/homes/pedwards/Documents/sampling_algorithm/BertiniLinuxMPI2_v1.5/bin/bertini
#"/cise/homes/pedwards/Documents/sampling_algorithm/mpich-install/bin/mpiexec"
if len(args) == 0: 
...
os.rename(os.path.join(minimizer_path,"finite_solutions"),os.path.join(minimizer_path,"start_points"))
